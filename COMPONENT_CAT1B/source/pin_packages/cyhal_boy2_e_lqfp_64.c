...
#if defined(_GPIO_BOY2_E_LQFP_64_H_)
#include "pin_packages/cyhal_boy2_e_lqfp_64.h"
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[14] = {
    ...
    {0u, 263u, P7_3, P7_3_TCPWM0_LINE_COMPL263},
    {0u, 516u, P8_1, P8_1_TCPWM0_LINE_COMPL516},
    {0u, 517u, P8_3, P8_3_TCPWM0_LINE_COMPL517},
    {0u, 518u, P9_1, P9_1_TCPWM0_LINE_COMPL518},
