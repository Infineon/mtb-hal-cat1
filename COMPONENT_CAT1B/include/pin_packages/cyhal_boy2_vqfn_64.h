/***************************************************************************//**
* \file cyhal_boy2_vqfn_64.h
*
* \brief
* BOY2 device GPIO HAL header for VQFN-64 package
*
********************************************************************************
* \copyright
...
#ifndef _CYHAL_BOY2_VQFN_64_H_
#define _CYHAL_BOY2_VQFN_64_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_boy2_vqfn_64 BOY2 VQFN-64
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the BOY2 VQFN-64 package.
 */
...
/** Definitions for all of the pins that are bonded out on in the VQFN-64 package for the BOY2 series. */
typedef enum {
...
} cyhal_gpio_boy2_vqfn_64_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_boy2_vqfn_64_t cyhal_gpio_t;
