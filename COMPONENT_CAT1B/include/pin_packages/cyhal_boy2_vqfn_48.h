...
#ifndef _CYHAL_BOY2_VQFN_48_H_
#define _CYHAL_BOY2_VQFN_48_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_boy2_vqfn_48 BOY2 VQFN-48
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the BOY2 VQFN-48 package.
 */
...
/** Definitions for all of the pins that are bonded out on in the VQFN-48 package for the BOY2 series. */
typedef enum {
...
} cyhal_gpio_boy2_vqfn_48_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_boy2_vqfn_48_t cyhal_gpio_t;
